...
class ReportRepository
{
    ...
    public function getFeePaymentData($params)
    {
        ...
        $query = $this->transaction->with([
            ...
            'studentFeeRecord.feeInstallment:id,title,fee_allocation_group_id',

            'studentFeeRecord.studentRecord:id,student_id,batch_id,admission_id',
            'studentFeeRecord.studentRecord.batch:id,name,course_id',
            'studentFeeRecord.studentRecord.batch.course:id,name,course_group_id,academic_session_id',
        ...
        ])->select(['id','prefix','number','student_fee_record_id','payment_method_id','account_id','amount','date','is_online_payment','source','reference_number','remarks'])->filterBySession()->whereNotNull('student_fee_record_id')->filterByHead('fee')->dateBetween([
