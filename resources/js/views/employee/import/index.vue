<template>
    <div>
        <div class="page-titles">
            <div class="row">
                <div class="col-12 col-sm-6">
                    <h3 class="text-themecolor">{{trans('employee.import')}} ({{getSession}})</h3>
                </div>
                <div class="col-12 col-sm-6">
        ...
        <div class="container-fluid">
        	<div class="card">
        		<div class="card-body">
                    <div class="p-4"><show-tip module="employee" tip="import_tip"></show-tip></div>
					...
					<template v-if="items.length">
                        ...
                        <div class="p-4">
                            <h4 class="card-title">{{trans('employee.column_selector')}}</h4>
    	                    <div class="row">
        ...
        watch: {
            file(file){
                ...
                if(fileExtension != 'csv'){
                    ...
                    axios.post('/api/employee/import/start',formData)
                    .then(response => {
